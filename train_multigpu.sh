# e.g.
# bash train_multigpu.sh Options/ntire/RetinexWT_NTIRE_8x2000.yml 0,1,2,3,4,5,6,7 4321
# bash train_multigpu.sh Options/ntire/RetinexWT_NTIRE_4x1800.yml 0,1,2,3,4,5,6,7 4329
