...
class WTFD(nn.Module): #小波变化高低频分解模块
    def __init__(self, in_ch, out_ch):
        ...
        self.wt = DWTForward(J=1, mode='zero', wave='db4')
        ...
        # self.mlp = MLP(out_ch, 2).cuda()  # CC 11.7
...
class WTFDown(nn.Module):#小波变化高低频分解下采样模块
    def __init__(self, in_ch, out_ch):
        ...
        self.mlp = MLP(out_ch, 2).cuda()  # CC 11.7
        # self.scam = SCAM(out_ch).cuda()  # CC 11.8
