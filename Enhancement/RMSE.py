...
if __name__ == '__main__':
    ave_psnr, ave_ssim, ave_rmse = evaluate_raindrop('/media/a204/742CCF0E2CCEC9F6/chenhj/RetinexWT/RetinexWT-master/results/LOL_v2_synthetic/RetinexWT_LOL_v2_synthetic_O/best_psnr_25', '/media/a204/742CCF0E2CCEC9F6/chenhj/RetinexWT/RetinexWT-master/data/LOLv2/Synthetic/Test/Normal')
    print('RMSE: ', ave_rmse)
